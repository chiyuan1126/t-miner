...
public class TestSingleFile {
	...
	public static void main(String[] args) throws ParseException, IOException {
		...
		String reimg_dir = "/Users/cy2465/Documents/projects/2022_Tabular_Info/toannimgre2/image_test/";
		...
		File pf=new File("/Users/cy2465/Documents/projects/2022_Tabular_Info/usecasepdfs/P19-1024.pdf");
		...
		for (int i = 0; i < 20; i++) {
			...
			for (int k = 0; k < ja.size(); k++) {
				...
				System.out.println("Scanning from:"+(startrow-12)+"\t"+(startrow+5));
				...
				startrow=(int) y_from;
				System.out.println("Scanning from:"+(startrow-12)+"\t"+(startrow+5));
				linepos=nearestLine(img_path,startrow-12,startrow+5,x_from, x_to);
				...
				write2imgfile(table_dir, pf,i, k, x_from, x_to, y_from, y_to, updated_img_path);
	...
	private static String nearestLine(String imgpath, int startrow, int endrow,float x_from,float x_to) {
			...
			//Imgcodecs.imwrite(imgpath+"-11111.jpg", img);
